...
const resources: Array<Resource> = [
    ...
    },
    {
        ...
        name: 'React Summit - Amsterdam, The Netherlands',
        description:
    ...
    },
    {
        ...
        name: 'Web Summit - Lisbon, Portugal',
        description:
...
function Resource({resource}: { resource: Resource }) {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute inset-0 rounded-2xl ring-1 ring-zinc-900/7.5 ring-inset group-hover:ring-zinc-900/10 dark:ring-white/10 dark:group-hover:ring-white/20"/>
            <div className="relative rounded-2xl px-4 pt-6 pb-4">
...
export function Resources() {
    return (
        <div className="my-16 xl:max-w-none">
            <Heading level={2} id="conferences">
                Conferences
            </Heading>
            <div
